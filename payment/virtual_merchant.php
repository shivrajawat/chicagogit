      ...
      : redirect_to("../checkout.php");
  	  ...
  	  if(!empty($_POST['patment_type'])):
	  	if($_POST['patment_type']=='is_vm'):
				...
				echo("<input type=\"hidden\" name=\"ssl_receipt_decl_get_url\" value=\"".SITEURL."/payment/return_virtual_merchant.php\">");
				echo("<input type=\"hidden\" name=\"ssl_receipt_apprvl_method\" value=\"REDG\">");
				echo("<input type=\"hidden\" name=\"ssl_receipt_apprvl_get_url\" value=\"".SITEURL."/payment/return_virtual_merchant.php\">");
				echo("</form>"); 
				echo("</body></html>");
				}
				else
