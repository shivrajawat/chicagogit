...
<?php
  ...
  define('_U_INSTALL', 'Install Manager');
  ...
  find some of the information required when trying to diagnose a problem.');
  define('SYS_SUB', 'Viewing System Information');
  define('SYS_CMS_INF', 'Kulacart Info');
  define('SYS_PHP_INF', 'PHP Info');
  define('SYS_SER_INF', 'Server Info');
  define('SYS_CMS_VER', 'Kulacart Version');
...
Here you only need the language file in the same format <strong>fr.lang.php</strong> without a country flag.');
  ...
  define('_MN_INFO', 'This is the control panel for your online food order solution. You can manager your website efficiently.');
  ...
  define('_UR_EMAIL_R2', 'Entered Username (Email Address) Is Not Valid.');
  ...
  define('_UR_NOLOCATION', '--- No Location Required---');
  ...
  define('_UR_ADMIN_T', 'Super Admin has full rights.<br />Admin has assignable permissions.');
  ...
  define('_UR_TITLE2', 'Manage KulaCart Users &rsaquo; Add User');
  ...
  define('_UR_TITLE3', 'Manage KulaCart Users');
  ...
  // Admin  Currency Master
  define('_N_CURRENCY', 'Currency Manager');
  define('_CUR_TITLE3', 'Manage Currency');
  define('_CURINFO3', 'Here you can manage your currency');
  define('_CUR_ADD', 'Add New Currency');
  define('_CUR_SUBTITLE3', 'Viewing Currency');
  define('_CUR_TITLE', 'Currency');
  define('_CUR_SYMBOL', 'Currency Symbol');
  define('_CUR_EDIT', 'Edit Currency');
  define('_CUR_TITLE2', 'Manage Currency &rsaquo; Add Currency');
  define('_CUR_INFO2', 'Here you can add new currency');
  define('_CUR_SUBTITLE2', 'Add Currency');
  define('_CUR_TITLE_R', 'Please Enter Your Currency');
  define('_CUR_SYM_TITLE_R', 'Please Enter Your Currency Symbol');
  define('_CUR_PUB', 'Currency Published');
  define('_CUR_UPDATED', '<span>Success!</span>Currency updated successfully!');
  define('_CUR_ADDED', '<span>Success!</span>Currency added successfully!');
  define('_CUR_NOCURRENCY', '<span>Alert!</span>You don\'t have any Currency under this page yet...');
  define('_CUR_TITLE1', 'Manage Currency &rsaquo; Edit Currency');
  define('_CUR_INFO1', 'Here you can update your Currency.');
  define('_CUR_SUBTITLE1', 'Edit Currency &rsaquo; ');
  define('_CUR_UPDATE', 'Update Currency');
  define('_CUR_UNI_NAME', 'Entered Currency Is Already Exit.');
  
  // Admin  Country Master
  define('_COUNTRY', 'Country');
  define('_N_COUNTRY', 'Country Manager');
  define('_COUN_TITLE3', 'Manage Country');
  define('_COUNINFO3', 'Here you can manage your Country');
  define('_COUN_ADD', 'Add New Country');
  define('_COUN_SUBTITLE3', 'Viewing Country');
  define('_COUNTRY_TITLE', 'Country Name');
  define('_COUNTRY_CODE', 'Country Code');
  define('_COUN_TITLE_R', 'Please Enter Your Country Name');
  define('_COUN_CODE_R', 'Please Enter Your Country Code');
  define('_COUN_CURRENCYID', 'Please Select Your Currency');
  define('_COUN_PUB', 'Country Published');
  define('_COUN_UPDATED', '<span>Success!</span>Country updated successfully!');
  define('_COUN_ADDED', '<span>Success!</span>Country added successfully!');
  define('_COUNTRY_NOCOUNTRY', '<span>Alert!</span>You don\'t have any Country under this page yet...');
  define('_COUNTRY_EDIT', 'Edit Country');
  define('_COUN_TITLE1', 'Manage Country &rsaquo; Edit Country');
  define('_COUN_INFO1', 'Here you can update your Country.');
  define('_COUN_SUBTITLE1', 'Edit Country &rsaquo; ');
  define('_COUN_UPDATE', 'Update Country');
  define('_COUN_UNI_NAME', 'Entered Country Is Already Exit.');
  define('_COUN_TITLE2', 'Manage Country &rsaquo; Add Country');
  define('_COUN_INFO2', 'Here you can add new Country');
  define('_COUN_SUBTITLE2', 'Add Country');
  
  // ADmin State Manager 
  define('_N_STATE', 'State Manager');
  define('_S_TITLE3', 'Manage State');
  define('_SATEINFO3', 'Here you can manage your state');
  define('_S_ADD', 'Add New State');
  define('_S_SUBTITLE3', 'Viewing State');
  define('_S_TITLE2', 'Manage State &rsaquo; Add State');
  define('_S_INFO2', 'Here you can add new State');
  define('_S_SUBTITLE2', 'Add State');
  define('_S_TITLE', 'State Name');
  define('_S_TITLE_R', 'Please Enter Your State Name');
  define('_ST_UPDATED', '<span>Success!</span>State updated successfully!');
  define('_ST_ADDED', '<span>Success!</span>State added successfully!');
  define('_ST_EDIT', 'Edit State');
  define('_ST_TITLE11', 'Manage State &rsaquo; Edit State');
  define('_ST_SUBTITLE1', 'Edit State &rsaquo; ');
  define('_ST_SYMBOL', 'Country Name');
  define('_ST_PUB', 'State Published');
  define('_ST_INFO1', 'Here you can update your state.');
  define('_ST_UPDATE', 'Update State');
  define('_ST_TITLE', 'State');

  
  
   // City manager admin
  define('_CI_MANAGER', 'City Manager');
  define('_CI_TITLE3', 'Manage Your City');
  define('_CITYINFO3', 'Here you can manage your City');
  define('_CI_ADD', 'Add New City');
  define('_CI_SUBTITLE3', 'Viewing City');
  define('_CI_NAME', 'City Name');
  define('_CI_EDIT', 'Edit City');
  define('_CI_PUB', 'City Published');
  define('_CI_TITLE_R', 'Please Enter City Name');
  define('_CI_TITLE2', 'Manage City &rsaquo; Add City');
  define('_CI_INFO2', 'Here you can add new City');
  define('_CI_SUBTITLE2', 'Add City');
  define('_CI_STATE_ID_R', 'Please Select State Name');
  define('_CI_ADDED', '<span>Success!</span>City added successfully!');
  define('_CI_UPDATED', '<span>Success!</span>City updated successfully!');
  define('_CI_TITLE1', 'Manage City &rsaquo; Edit City');
  define('_CI_INFO1', 'Here you can update your City.');
  define('_CI_SUBTITLE1', 'Edit City &rsaquo; ');
  define('_CI_UPDATE', 'Update City');
  define('_CI_UNI_NAME', 'Entered City Name Is Already Exit.');
  
  // company manager admin
  
   define('_CM_MANAGER', 'Company Manager');
   define('_CM_TITLE3', 'Manage Your Company');
   define('_CompanyINFO3', 'Here you can manage your Company');
   define('_CM_SUBTITLE3', 'Viewing Company');
   define('_CM_ADD', 'Add New Company');
   define('_CM_TITLE2', 'Manage Company &rsaquo; Add Company');
   define('_CM_INFO2', 'Here you can add new Company');
   define('_CM_SUBTITLE2', 'Add Company');
   define('_CM_NAME', 'Company Name');
   define('_CM_PUB', 'Company Published');
   define('_CM_GA', 'Address1');
   define('_CS_GA', 'Address2');
   define('_CM_timezone', 'Time Zone');
   define('_CM_PHONE', 'Phone Number1');
   define('_CM_PHONE1', 'Phone Number2');
   define('_CM_FAX', 'Fax Number');
   define('_CM_ZIP', 'Zip Code');
   define('_CM_LATI', 'Latitude');
   define('_CM_LONG', 'Longitude');
   define('_CM_WEB', 'Website');
   define('_CM_APP', 'Application');
   define('_CM_SP', 'Specialist');
   define('_CM_LOGO', 'Company Logo');
   define('_CM_ADDED', '<span>Success!</span>Company added successfully!');
   define('_CM_TITLE_R', 'Please Enter Company Name');
   define('_CM_UPDATED', '<span>Success!</span>Company updated successfully!');
   define('_CM_SUBTITLE1', 'Edit Company &rsaquo; ');
   define('_CM_INFO1', 'Here you can update your company.');
   define('_CM_UPDATE', 'Update Company');
   define('_CM_TITLE1', 'Manage Company &rsaquo; Edit Company');
   define('_CM_EDIT', 'Edit Company');
   
   // location manager admin 
  define('_LM_MANAGER', 'Location Manager');
  define('_LM_TITLE3', 'Manage Your Location');
  define('_LocationINFO3', 'Here you can manage your Location');
  define('_LM_ADD', 'Add New Location');
  define('_LM_SUBTITLE3', 'Viewing Location');
  define('_LMI_ADD', 'Add New Location');
  define('_LM_NAME', 'Company Name');
  define('_LM_GA', 'Address1');
  define('_LS_GA', 'Address2');
  define('_LM_timezone', 'Time Zone');
  define('_LM_PHONE', 'Phone Number1');
  define('_LM_PHONE1', 'Phone Number2');
  define('_LM_FAX', 'Fax Number');
  define('_LM_ZIP', 'Zip Code');
  define('_LM_LATI', 'Latitude');
  define('_LM_LONG', 'Longitude');
  define('_LM_WEB', 'Website');
  define('_LM_APP', 'Zone ID');
  define('_LM_SP', 'Specialist');
  define('_LM_LS', 'Location Slogan');
  define('_LM_PA', 'PickupAvailable');
  define('_LM_DA', 'Delivery Available');
  define('_LM_DAB', 'DineinAvailable');
  define('_LM_DAC', 'DeliveryFee');
  define('_LM_AF', 'AdditionalFee');
  define('_LM_GT', 'Gratuity');
  define('_LM_ST', 'Sales Tax');
  define('_LM_MAO', 'Maximum AdvanceOrder');
  define('_LM_STI', 'Sales TaxID');
  define('_LM_EDC', 'Email Disclaimer');
  define('_LM_LOGO_DEL', 'Is Same Company Address');
  define('_LM_PICK_AVL', 'Pick Up Available');
  define('_LM_DEL_AVL', 'Delievery Available');
  define('_LM_UPDATED', '<span>Success!</span>Location updated successfully!');
  define('_LM_ADDED', '<span>Success!</span>Location added successfully!');
  define('_LM_TITLE2', 'Manage Location &rsaquo; Add Location');
  define('_LM_INFO2', 'Here you can add new Location');
  define('_LM_SUBTITLE2', 'Add Location');
  define('_LM_TITLE1', 'Edit Location');
  define('_LM_INFO1', 'Manage Location &rsaquo; Edit Location');
  define('_LM_SUBTITLE1', 'Edit Location &rsaquo; ');
  define('_LM_EDIT', 'Edit Location');
  define('_LM_UPDATE', 'Update Location');
  define('_LMD_MANAGER', 'Location');
  define('_LM_STATUS', 'Order Availability');
  define('_LM_PUB', 'Location Published');
  define('_LM_LON', 'Location Name');
  define('_LM_RES', 'Restaurant Name');
  define('_PO_NOLOCATION', '<span>Alert!</span>You don\'t have any location under this page yet...');
   
   
     // location  Timing manager admin 
  define('_LTM_MANAGER', 'Location Timing');
  define('_LTM_TITLE3', 'Manage Your Location Timing');
  define('_Time_LocationINFO3', 'Here you can manage your location time');
  define('_LTM_ADD', 'Add Location Timing');
  define('_LTM_SUBTITLE3', 'Viewing Location Timing');
  define('_LTM_NAME', 'Location Name');
  define('_LTM_DY', 'Days');
  define('_LTM_DST', 'Day Start Time');
  define('_LTM_DET', 'Day End Time');
  define('_LTM_LDT', 'Last order Time');
  define('_LTM_O24', 'Opon 24Hours');
  define('_LTM_IH', 'Holiday');
  define('_LTM_BRS', 'Breakfast Start');
  define('_LTM_BFE', 'Breakfast End');
  define('_LTM_BFL', 'Breakfast Last');
  define('_LTM_LS', 'Launch Start');
  define('_LTM_EDIT', 'Edit Timing');
  define('_LTM_UPDATED', '<span>Success!</span>Location Time updated successfully!');
  define('_LTM_ADDED', '<span>Success!</span>Location Time added successfully!');
  define('_LTM_TITLE2', 'Manage Time Location &rsaquo; Add Time Location');
  define('_LTM_INFO2', 'Here you can add new Time Location');
  define('_LTM_SUBTITLE2', 'Add Location Time');
  define('_LTM_TITLE1', 'Edit Location Time');
  define('_LTM_INFO1', 'Manage Location Time &rsaquo; Edit Location Time');
  define('_LTM_SUBTITLE1', 'Edit Location Time &rsaquo; ');
  define('_LTM_UPDATE', 'Update Location Time');
  define('_LTD_MANAGER', 'Time Location');
  define('_LTM_NOLOCTIME', '<span>Alert!</span>You don\'t have any Location time under this page yet...');
 
   
   // Delivery Area Map manager 
   define('_DLI_TITLE3', 'Manage Delivery Area');
   define('_DLINFO3', 'Here you can manage your delivery area');
   define('_DLI_ADD', 'Add New Delivery Area');
   define('_DLI_SUBTITLE3', 'Viewing Delivery Area');
   define('_DLI_TITLE2', 'Manage Delivery Area &rsaquo; Add Delivery Area');
   define('_DLI_INFO2', 'Here you can add new delivery area');
   define('_DLI_SUBTITLE2', 'Add Delivery Area');
   define('_DIL_TITLE', 'Address');
   define('_DIL_LOC', 'Location');
   define('_DLA_EDIT', 'Edit Delivery Area');
   define('_DLA_NODELIVERY', '<span>Alert!</span>You don\'t have any Delivery Area under this page yet...');
   define('_DLA_TITLE1', 'Manage Delivery Area &rsaquo; Edit Delivery Area');
   define('_DLA_INFO1', 'Here you can update your delivery area.');
   define('_DLA_SUBTITLE1', 'Edit Content Delivery Area &rsaquo; ');
   define('_DLA_UPDATE', 'Update Delivery Area');
   define('_DLA_ADDED', '<span>Success!</span>Delivery Area added successfully!');
   define('_LOCATION_UNI_ID', 'Selected Location Is Already Exit.');
   define('_DLA_UPDATED', '<span>Success!</span>Delivery Area updated successfully!');
   define('_DLI_', 'Delivery Area');
   
   
   
    // Holidays manager admin
  
   define('_HM_MANAGER', 'Holiday Manager');
   define('_H_TITLE3', 'Manage Holidays');
   define('_HOLYINFO3', 'Here you can manage your Holidays');
   define('_H_ADD', 'Add New Holiday');
   define('_H_SUBTITLE3', 'Viewing Holidays');
   define('_H_TITLE', 'Location Name');
   define('_HOLY_DATE', 'Holiday Date');
   define('_HT_UPDATED', '<span>Success!</span>Holidays updated successfully!');
   define('_HT_ADDED', '<span>Success!</span>holidays added successfully!');
   define('_H_TITLE2', 'Manage Holidays &rsaquo; Add Holidays');
   define('_H_INFO2', 'Here you can add new Holidays');
   define('_H_SUBTITLE2', 'Add Holidays');
   define('_HD_NOHOLIDAYS', '<span>Alert!</span>You don\'t have any Holiday under this page yet...');
   define('_HT_TITLE11', 'Manage Holiday &rsaquo; Edit Holiday');
   define('_HT_INFO1', 'Here you can update your Holidays.');
   define('_HT_SUBTITLE1', 'Edit Holiday &rsaquo; ');
   define('_HT_UPDATE', 'Update Holiday');
   define('_HD_MANAGER', 'Holidays');
   define('_HT_EDIT', 'Edit Holiday');
  
   
  
   // Customer Master manager admin
   define('_CMM_MANAGER', 'Customer Manager'); 
   define('_CustomerINFO3', 'Here you can manage your Customer');
   define('_CMM_ADD', 'Add New Customer');
   define('_CMM_SUBTITLE3', 'Viewing Customer');
   define('_CMM_TITLE2', 'Manage Customer &rsaquo; Add Customer');
   define('_CMM_INFO2', 'Here you can add new Customer');
   define('_CMM_SUBTITLE2', 'Add Customer');
    define('_CMM_EDIT', 'Edit Customer');
   define('_CMM_FIR', 'First Name');
   define('_CMM_LST', 'Last Name');
   define('_CMM_EML', 'Email ID');
   define('_CMM_PASS', 'Password');
   define('_CMM_PHONE', 'Phone Number');
    define('_CMM_GA', 'Address1');
   define('_CSM_GA', 'Address2');
    define('_DMM_GA', 'Address1');
   define('_DSM_GA', 'Address2');
 
 // Menu manager admin
 define('_MENU_', 'Main Menu');
 define('_N_MENU', 'Menu Manager');
 define('_MENU_TITLE3', 'Manage Menu');
 define('_MENUINFO3', 'Here you can manage your Menu');
 define('_MENU_ADD', 'Add New Menu');
 define('_MENU_ADDPAGE', 'Save This Menu');
 define('_MENU_SUBTITLE3', 'Viewing Menu');
 define('_MENU_TITLE', 'Menu Name');
 define('_MENU_SHOW', 'Show Menu');
 define('_MENU_EDIT', 'Edit Menu');
 define('_MENU_NOMENU', '<span>Alert!</span>You don\'t have any Menu under this page yet...');
 define('_MENU_PUB', 'Currency Published');
 define('_MENU_TITLE2', 'Manage Menu &rsaquo; Add Menu');
 define('_MENU_INFO2', 'Here you can add new Menu');
 define('_MENU_SUBTITLE2', 'Add Menu');
 define('_MENU_TITLE1', 'Manage Menu &rsaquo; Edit Menu');
 define('_MENU_INFO1', 'Here you can update your Menu.');
 define('_MENU_SUBTITLE1', 'Edit Menu &rsaquo; ');
 define('_MENU_UPDATED', '<span>Success!</span>Menu updated successfully!');
 define('_MENU_TITLE_R', 'Please Enter Your Menu');
 define('_MENU_UNI_NAME', 'Entered Menu Is Already Exit.');
 define('_MENU_ADDED', '<span>Success!</span>Menu added successfully!');
 define('_MENU_UPDAT', 'Menu Update');
 define('_MENUB_EDIT', 'Edit Menu');

 
    
 // menu Location mapping Admin 
 define('_N_MENUMAPPING', 'Menu Location Mapping');
 define('_MLMAP_TITLE3', 'Manage Menu Location Mapping');
 define('_MLMAPINFO3', 'Here you can manage your Menu Location Mapping');
 define('_MLMAP_SUBTITLE3', 'Viewing Menu location Mapping');
 define('_MLMAP_ADD', 'Add New Menu Location');
 define('_MLMAP', 'Menu Name');
 define('_MLMAP_TITLE', 'Menu Location');
 define('_MLMAP_TITLE2', 'Manage Menu Location &rsaquo; Add Menu location');
 define('_MLMAP_INFO2', 'Here you can add new Menu Location');
 define('_MLMA_ADD', 'Add New Menu Location');
 define('_MLMAP_PUB', 'Menu Location Published');
 define('_MLMAP_SUBTITLE2', 'Add Menu Location');
 define('_MLMAP_UPDATED', '<span>Success!</span>Menu Location updated successfully!');
 define('_MLMAP_ADDED', '<span>Success!</span>Menu Location added successfully!');
 define('_MLMAP_EDIT', 'Edit Menu Locaton');
 define('_MLMAP_TITLE11', 'Manage Menu &rsaquo; Edit Menu Location');
 define('_MLMAP_INFO1', 'Here you can update your Menu Location.');
 define('_MLMAP_SUBTITLE1', 'Edit Menu Location &rsaquo; ');
 define('_MLMAP_UPDATE', 'Update Menu Location');
 define('_LOC_NOLOCMAPPING', '<span>Alert!</span>You don\'t have any menu location mapping under this page yet...');
 define('_LOC_UNI_LOCAMENU', 'Entered Location Mapping Is Already Exit.');
 
    
 // menu Category Master Admin 
 define('_MCAT_MENUMAPPING', 'Menu Category Master');
 define('_MCAT_TITLE3', 'Manage Menu Category ');
 define('_MCATINFO3', 'Here you can manage your Menu Category');
 define('_MCAT_ADD', 'Add New Menu Category');
 define('_MCAT_SUBTITLE3', 'Viewing Menu Category');
 define('_MCAT', 'Category Name');
 define('_MCATD', 'Category Description');
 define('_MENU_CAT', 'Show Category');
 define('_MCAT_TITLE2', 'Manage Menu Category &rsaquo; Add Menu Category');
 define('_MCAT_INFO2', 'Here you can add new Menu Category');
 define('_MCAT_SUBTITLE2', 'Add Menu Category');
 define('_MCAT_TITLE11', 'Manage Category &rsaquo; Edit Menu Category');
 define('_MCAT_INFO1', 'Here you can update your Menu Category.');
 define('_MCAT_SUBTITLE1', 'Edit Menu Category &rsaquo; ');
 define('_MCAT_UPDATED', '<span>Success!</span>Menu Category updated successfully!');
 define('_MCAT_ADDED', '<span>Success!</span>Menu Category added successfully!');
 define('_MCAT_EDIT', 'Edit Menu Category');
 define('_MCAT_TITLE', 'Menu Category');
 define('_MLDIS', 'Display Order');
 define('_MCAT_UPDATE', 'Save Menu Category');
 define('_MCAT_SAVCL', 'Save And Close');
 define('_MCAT_SAVNEW', 'Save And Add New ');
 define('_MCAT_NOCATEGORY', '<span>Alert!</span>You don\'t have any Menu Category under this page yet...');
 
     
 // menu Size Master Admin 
 define('_MSIZE_MENUMAPPING', 'Menu Size Master');
 define('_MSIZE_TITLE3', 'Manage Menu Size ');
 define('_MSIZEINFO3', 'Here you can manage your Menu Size');
 define('_MSIZE_ADD', 'Add New Menu SIZE');
 define('_MSIZE_SUBTITLE3', 'Viewing Menu Size');
 define('_MSIZE_NOSIZE', '<span>Alert!</span>You don\'t have any Menu Size under this page yet...');
 define('_MSIZE_TITLE2', 'Manage Menu Size &rsaquo; Add Menu Size');
 define('_MSIZE_INFO2', 'Here you can add new Menu Size');
 define('_MSIZE_SUBTITLE2', 'Add Menu Size');
 define('_MSIZE_TITLE11', 'Manage Size &rsaquo; Edit Menu Size');
 define('_MSIZE_INFO1', 'Here you can update your Menu Size.');
 define('_MSIZE_SUBTITLE1', 'Edit Menu Size &rsaquo; ');
 define('_MSIZE_UPDATE', 'Save Menu Size');
 define('_MSIZE', 'Size Name');
 define('_MSTICKET', 'Ticket Size ID');
 define('_MSACTIVE', 'Published');
 define('_MSIZE_UPDATED', '<span>Success!</span>Menu Size updated successfully!');
 define('_MSIZE_ADDED', '<span>Success!</span>Menu Size added successfully!');
 define('_MSIZE_EDIT', 'Edit Menu Size');
 define('_MSIZE_ADDCLOSE', 'Save And Close');


 
 // Location Setting Master Admin 
 define('_LS_SETTING', 'Location Setting');
 define('_LS_TITLE3', 'Manage Your Location Setting');
 define('_LSETTINFO3', 'Here you can manage your Location Setting');
 define('_LS_ADD', 'Add New Location Setting');
 define('_LS_SUBTITLE3', 'Viewing Location Setting');
 define('_LS_TITLE2', 'Manage Location Setting &rsaquo; Add Location Setting');
 define('_LS_INFO2', 'Here you can add new Location Setting');
 define('_LS_SUBTITLE2', 'Add Locatin Setting');
 define('_LSSM', 'Smtp Host');
 define('_LSUS', 'UserName');
 define('_LSPS', 'Password');
 define('_LSFU', 'FaxUrl');
 define('_LSFUSER', 'Fax Username');
 define('_LSPASSWORD', 'Fax Password');
 define('_LSGAPI', 'Google API Key');
 define('_LSGASCRIPT', 'Google Anaytics Script');
 define('_LSSEMAIL1', 'Support Email1');
 define('_LSSEMAIL2', 'Support Email2');
 define('_LSSEMAIL3', 'Support Email3');
 define('_LSSEMAIL4', 'Support Email4');
 define('_LSFURL', 'FB Url');
 define('_LSTURL', 'Twitter Url');
 define('_LSYURL', 'YouTube Url');
 define('_LSPURL', 'Pininterest Url');
 define('_LSPIURL', 'Yelp Url');
 define('_LS_TITLE1', 'Manage Location Setting &rsaquo; Edit Location Setting');
 define('_LS_INFO1', 'Here you can update your Location Setting.');
 define('_LS_SUBTITLE1', 'Edit Location Setting &rsaquo; ');
 define('_LSU_ADD', 'Update Location Setting');
 define('_LS_UPDATED', '<span>Success!</span>Location Setting updated successfully!');
 define('_LS_ADDED', '<span>Success!</span>Location Setting added successfully!');
 define('_LSE_EDIT', 'Edit Location Setting');
 define('_LS_NOLOSET', '<span>Alert!</span>You don\'t have any Location Setting under this page yet...');
 define('_LSE_TITLE_R', 'Please Select Your Location Name');
 define('_LSE_UNI_NAME', 'Entered Location Is Already Exit.');
 
 //  Menu Item Master Admin 
 define('_MITEM_MITEM', 'Menu Item Master');
 define('_MITEM_TITLE3', 'Manage Your Menu Item');
 define('_MITEMINFO3', 'Here you can manage your Menu Item <strong>Note: Deleting parent menu item will also delete all children assigned under the same parent.</strong>');
 define('_MITEM_ADD1', 'Save And Close');
 define('_MITEM_ADD', 'Add New Item');
 define('_MITEM_SUBTITLE3', 'Viewing Menu Item');
 define('_MITEM_EDIT', 'Edit Menu Item');
 define('_MITEM_TITLE2', 'Manage Menu Item &rsaquo; Add Menu Item');
 define('_MITEM_INFO2', 'Here you can add new Menu Item');
 define('_MITEM_SUBTITLE2', 'Add Menu Item');
 define('_MITEM_TYPE', 'Item Type');
 define('_MITEM_NAME', 'Item Name');
 define('_MITEM_SIN', 'Short Item Name');
 define('_MITEM_DESC', 'Item Description');
 define('_MITEM_MIQ', 'Min.Qty');
 define('_MITEM_MAQ', 'Max.Qty');
 define('_MITEM_PRE', 'Preparation Time');
 define('_MITEM_ODOS', 'Out Of Stock');
 define('_MITEM_SIIM', 'Size');
 define('_MITEM_SIIO', 'Show Item In Option');
 define('_MITEM_PRICE', 'Price');
 define('_MITEM_BII', 'Big Item Image');
 define('_MITEM_TII', 'Thumb Item Image');
 define('MITEM_PUB', ' Published');
 define('MITEM_TID', ' Ticket Item ID');
 define('MITEM_NUTRI', 'Nutrition Ingredient');
 define('MTYPE', ' Menu Type ');
 define('MAVL', ' Available Days');
 define('_MITEM_TITLE1', 'Manage menu item &rsaquo; Edit Menu Item');
 define('_MITEM_INFO1', 'Here you can update your Menu Item.');
 define('_MENUITEM_UPDATED', '<span>Success!</span>Menu Item updated successfully!');
 define('_MENUITEM_ADDED', '<span>Success!</span>Menu Item added successfully!');
 define('_MENUITEM_', 'Menu Item');
 define('_MI_NOMENUITEM', '<span>Alert!</span>You don\'t have any Menu Item under this page yet...');
 define('_CUSVIEW_', 'View');
 define('ITEM_OPTIONADD','Add Option');
 define('_MITEM_TITLEOP', 'Manage Menu Item Option &rsaquo; Add Menu Item Option');
 define('ITEM_SEOPTION','Select Option ');
 define('ITEM_OPTIONTOITEM','Add Option To Item');
 define('ITEM_IOPTIONADD', 'Add and Save Selected Option');
 
 // Customer Manager Admin 
 define('_CUS_TITLE1', 'Manage Customer &rsaquo; Edit Customer');
 define('_CUS_INFO1', 'Here you can update your Customer.');
 define('_CUS_SUBTITLE1', 'Edit Customer &rsaquo; ');
 define('_CUS_UPDATE', 'Update Customer');
 define('MOD_CM_APPROVED', '<span>Success!</span>Selected Comments have been approved.');
 define('MOD_CM_NA', '<span>Alert!</span>Please select data to process!');
 define('_TR_STATUS_FILTER', 'Status Filter');
 
 // AInstall Manager admin
 define('_INS_TITLE1', 'Manage website installation &rsaquo; Edit Post');
 define('_INS_INFO1', 'Here you can update your website installation.');
 define('_INS_SUBTITLE1', 'Edit website installation &rsaquo; ');
 define('_INS_UPDATE', 'Update Website Installation');
 define('_INS_TITLE2', 'Manage Website Installation &rsaquo; Add Website Installation');
 define('_INS_INFO2', 'Here you can add new Website Installation');
 define('_INS_SUBTITLE2', 'Add Website Installation');
 define('_INS_TITLE3', 'Manage Website Installation');
 define('_INSINFO3', 'Here you can manage your Website Installation');
 define('_INS_ADD', 'Add New Website Installation');
 define('_INS_SUBTITLE3', 'Viewing Website Installation');
 define('_INS_PUB', 'Website Installation Published');
 define('_INS_FLOW','Website Flow');
 define('_INS_BYLOCATION', 'By Location');
 define('_INS_BYMENU', 'By Menu');
 define('_INS_OTHER', 'Other');
 define('_INS_BYHYBRID', 'By Hybird');
 define('_INS_DEFAULT', 'Default Location');
 define('_INS_WEBSITe', 'Website URl');
 define('_INS_TITLE_R', 'Please Enter Website URl ex. http://subdomain.domain.com');
 define('_INS_NOWEBINSTALL', '<span>Alert!</span>You don\'t have any Website Installation under this page yet...');
 define('_INS_UPDATED', '<span>Success!</span>Website Installation updated successfully!');
 define('_INS_ADDED', '<span>Success!</span>Website Installation added successfully!');
 define('_INS_LOCA','Please Select Your Location Name');
 define('_INS_EDIT', 'Edit Website Installation');
 
   // Coupon Master manager admin
   define('_CPN_MANAGER', 'Coupon Manager'); 
   define('_CPN_ORDER_MANAGER', 'Order Manager'); 
   define('_CPN_TITLE3', 'Manage Coupon Master ');
   define('_CPNINFO3', 'Here you can manage your Coupon Master');
   define('_CPN_ADD', 'Add New Coupon Master');
   define('_CPN_SUBTITLE3', 'Viewing Coupon Master');
   define('_CPN_NOSIZE', '<span>Alert!</span>You don\'t have any Coupon Master under this page yet...');
   define('_CPN_TITLE2', 'Manage Coupon Master &rsaquo; Add Coupon Master');
   define('_CPN_INFO2', 'Here you can add new Coupon Master');
   define('_CPN_SUBTITLE2', 'Add Coupon Master');
   define('_CPN_TITLE', 'Coupon Title');
   define('_CPN_NOOFCOP', 'No Of Coupon');
   define('_CPN_TODIS', 'Type Of Discount');
   define('_CPN_DISCNT', 'Coupon-Discount');
   define('_CPN_NOOFUSEA', 'No Of Use Allowed');
   define('_CPN_CREDATE', 'Start Date');
   define('_CPN_ENDATE', 'End Date');
   define('_CPN_ACTIVE', 'Published');
   define('_CPN_DESC', 'Description');
   define('_CPN_USNO', 'Used NO');
   define('_CPN_UPDATED', '<span>Success!</span>Coupon Master updated successfully!');
   define('_CPN_ADDED', '<span>Success!</span>Coupon Master added successfully!');
   define('_PERCENT', 'Percent');
   define('_FIXED', 'Fixed');
   define('_PREVIEW', 'Preview');
   
   // Admin Menu Option Manager 
   define('_MENU_OPTION', 'Menu Option Master ');
   define('_MIO_TITLE1', 'Manage Menu Option &rsaquo; Edit Menu Option');
   define('_MIO_INFO1', 'Here you can update your Menu Option.');
   define('_MIO_SUBTITLE1', 'Edit  Menu Option &rsaquo; ');
   define('_MIO_UPDATE', 'Update Menu Option');
   define('_MIO_TITLE2', 'Manage Menu Option &rsaquo; Add Menu Option');
   define('_MIO_INFO2', 'Here you can add new Menu Option');
   define('_MIO_SUBTITLE2', 'Add Menu Option');
   define('_MIO_ADD', 'Add New Menu Option');
   define('_MIO_TITLE3', 'Manage Menu Option');
   define('_MIOINFO3', 'Here you can manage your Menu Option');
   define('_MIO_SUBTITLE3', 'Viewing Menu Option');
   define('_MIO_OP_NMAE','Item Option Name');
   define('_MIO_TITLE_R', 'Please Enter Option Name');
   define('_MIO_INST','Instruction');
   define('_MIO_INST_R', 'Please Enter Instruction');
   define('_MIO_PUB', 'Menu Option Published');
   define('_MIO_ISNOEMAL', 'Is Normal Option');
   define('_CG_ISNORMAL_T', 'At front end, we will show a checkbox, On check of that it, other option to add option, choice & topping will be appeared otherwise list of options will be displayed.');
   define('_MIO_HCHOICE', 'Have Choice');
   define('_MIO_HTOOPING', 'Have Toppings');
   define('_MIO_COPTION', 'Child Option ');
   define('_MIO_CHOISE', 'Choice');
   define('_MIO_MIN_CHOISE', 'Min');
   define('_MIO_MAX_CHOISE', 'MAX');
   define('_MIO_SIZEAFFP', 'Size Affect Price');
   define('_MIO_OPTYPE', 'Option Type');
   define('_MIO_ISDEFAULT', 'Is Default');
   define('_MIO_Maximum_R', 'Maximum Choice is Required');
   define('_MIO_Minimum_R', 'Minimum Choice is Required');
   define('_MIO_UPDATED', '<span>Success!</span>Menu Option updated successfully!');
   define('_MIO_ADDED', '<span>Success!</span>Menu Option added successfully!');
   define('_MIO_DEFAULT', 'Default');
   define('_MIO_EDIT', 'Edit Menu Option');
   define('_MIO_NOOPTIONMENU', '<span>Alert!</span>You don\'t have any Menu Option under this page yet...');
   define('_MENU_CHOICE', 'Menu Option Choice Master ');
   
    // Page Master manager admin
   define('_PAGE_MANAGER', 'Page Manager'); 
   define('_PAGE_TITLE1', 'Manage Page Master &rsaquo; Edit Page Master');
   define('_PAGE_INFO1', 'Here you can update your Page Master.');
   define('_PAGE_SUBTITLE1', 'Edit Page Master &rsaquo; ');
   define('_PAGE_UPDATE', 'Update Page Master');
   define('_PAGE_TITLE2', 'Manage Page master &rsaquo; Add Page Master');
  define('_PAGE_INFO2', 'Here you can add new Page Master');
  define('_PAGE_SUBTITLE2', 'Add Page Master');
  define('_PAGE_ADD', 'Add New Page Master');
  define('_PAGE_TITLE', 'Page Title');
  define('_PAGE_PUB', 'Page Published');
  define('_PAGE_DESC', 'Description');
  define('_PAGE_EDIT', 'Edit Page Master');
   define('_PAGE_TITLE3', 'Manage Page Master');
  define('_PAGEINFO3', 'Here you can manage your Page Master');
  define('_PAGE_SUBTITLE3', 'Viewing Page Master');
  define('_PAGEM_NOCURRENCY', '<span>Alert!</span>You don\'t have any Page under this page yet...');
   define('_PAGEM_UPDATED', '<span>Success!</span>Page Master  updated successfully!');
   define('_PAGEM_ADDED', '<span>Success!</span>Page Master added successfully!');
  
   // empty garbage manager admin
   define('_N_GARBASE', 'Empty Garbage Collection');
   // Change password admin
  define('_SEND_SMS', 'Empty Garbase');
  define('_SMS_TITLE2', 'Manage Garbase &rsaquo; Delete Garbase');
  define('_SMS_INFO2', 'Here you can Delete Empty Garbase.');
  define('_SMS_SUBTITLE2', 'Delete Garbase');
  define('_SMS_ADD', ' Delete SMS');
  define('_SMS_ADD_NEW', 'Delete Garbase');
  
  
  // xml upload 
  define('_XML_TITLE2', 'Manage Menu Item Xml &rsaquo; Upload Menu Item Xml');
  define('_XML_SUBTITLE2', 'Upload New Menu Item Xml File');
   define('_XML_ADD', 'Upload New Menu Item Xml');
   define('_XML_AVATAR', 'Uplod XML File');
 ?>