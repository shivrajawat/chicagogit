                          ...
                          <tbody>
                            <tr>                               
                              ...
                              <tr rowchoiceno="0" id="Toppingtr<?php echo $i; ?>">                                      
                                      <td><input name="topping_name[]" id="toppingname<?php echo $i; ?>" type="text" class="inputbox"  size="55" value="<?php echo $omtrow['topping_name'];?>"/></td>
                                      <td><input name="out_of_stock[]" type="checkbox" value="1" class="checkbox" <?php getChecked($omtrow['out_of_stock'], 1); ?>/></td>
                                      <td>
                                 <select name="change_value[]" class="custombox" style="width:300px" onchange="getvalueFrom_toppingitem('<?php echo $i; ?>',this.value)">
											<?php $itemmenulist = $menu->getToppingMenuItem(); ?>
                                            <option value="">please select</option>
                                            <?php foreach ($itemmenulist as $irow):?>
                                            <?php  //$sel = ($irow['location_id'] == $omtrow['id']) ? ' selected="selected"' : '' ;?>
                                            <option value="<?php echo $irow['MenuItemID'];?>/<?php echo $irow['MenuSizeMapID'];?>"><?php echo $irow['price'];?></option>
                                            <?php  endforeach;?>
                                        </select>
                                         <input type="hidden" name="menu_size_map_id[]" value="<?php echo $omtrow['menu_size_map_id'];?>"  id="MenuSizeMapID1" />
                                        <input type="hidden" name="menu_item_id[]" value="<?php echo $omtrow['menu_item_id'];?>"  id="MenuItemID1" />
                          ...
                          <tbody>
                            <tr>                               
                              ...
                              <tr rowchoiceno="0" id="Toppingtr1">                                      
                                <td>
                                <input name="topping_name[]" type="text" id="toppingname1" class="inputbox"  size="55" title="<?php echo _MIO_INST_R;?>"/>
                                </td>
                                <td><input name="out_of_stock[]" type="checkbox" value="1" class="checkbox"/></td>
                                <td>
                                  <select name="change_value" class="custombox" style="width:300px" onchange="getvalueFrom_toppingitem('1',this.value)">
									<?php $itemmenulist = $menu->getToppingMenuItem(); ?>
                                    <option value="">please select</option>
                                    <?php foreach ($itemmenulist as $irow):?>
                                    <option value="<?php echo $irow['MenuItemID'];?>/<?php echo $irow['MenuSizeMapID'];?>"><?php echo $irow['price'];?></option>
