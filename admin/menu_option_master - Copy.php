          ...
          <tr>
            <td colspan="2" style="padding:0"><table class="forms" id="is_normal_hide">
                ...
                <tr>
                  ...
                  <td><input name="have_toppings" type="checkbox" value="1" class="checkbox" <?php getChecked($row['have_toppings'], 1); ?>/></td>
                </tr>
              </table></td>
          </tr>
          <tr>
            <td colspan="2" style="padding:0"><table class="TextBoxesGroup forms" id="choise_show" style="display:none;">
                <tr>
                  <th>Choice Name</th>
                  <th>Description </th>
                  <th>Image </th>
                ...
                <?php $menuoptionchoise = $menu->getMenuOptionChoice($row['option_id']);
						if($menuoptionchoise):
						foreach($menuoptionchoise as $mocrow):
					?>
                <tr id="TextBoxDiv1">
                  <td><input name="choice_name[]" type="text" class="inputbox"  size="25" value="<?php echo $mocrow['choice_name'];?>"/></td>
                  <td><input name="choice_description[]" type="text" class="inputbox"  size="25" value="<?php echo $mocrow['choice_description'];?>"/></td>
                  <td><div class="fileuploader">
                      <input type="text" class="filename" readonly="readonly" style="width:140px;"/>
                  ...
                  <td><select name="is_add_price[]" class="custombox" style="width:100px">
                      <option value="1" <?php if($mocrow['is_add_price']=='1') { echo 'selected="selected"'; } ?>>YES</option>
                      <option value="0" <?php if($mocrow['is_add_price']=='0') { echo 'selected="selected"'; } ?>>NO</option>
                    </select>
                    <img src="images/add.png" id='addButton' style="cursor:pointer;"  class="tooltip"  alt="" title="Add new field"/> </td>
                </tr>
                <input type="hidden"  name="optionid[]" value="<?php echo $mocrow['option_choice_id']; ?>"/>
...
$(document).ready(function(){
 ...
 /* $("#addButton").click(function(){
	  ...
	  // first memthod...we can write div element
		var maincontent='<td><input name=\"choice_name[]\" type=\"text\" class=\"inputbox\"  size=\"25\"></td><td><input name="choice_description[]" type="text" class="inputbox"  size="25"></td><td><div class="fileuploader"><input type="text" class="filename" readonly="readonly" style="width:140px;"/><input type="button" name="file" class="filebutton" value="<?php echo _BROWSE;?>"/><input type="file" name="choice_image[]" /></div></td><td><select name="is_add_price[]" class="custombox selectboxnew" style="width:100px"><option value="0">YES</option><option value="0">NO</option></select><img src=\"images/delete.png\" id=\'removeButton\' style=\"cursor:pointer; margin-left:5px;\"  class=\"tooltip\"  alt=\"\" title=\"Remove new field\"></td>';	
                          ...
                          <tbody>
                            <tr>                               
                              ...
                              <tr rowchoiceno="0" id="Toppingtr1">                                      
                                      <td><input name="topping_name[]" type="text" class="inputbox"  size="55" title="<?php echo _MIO_INST_R;?>"/></td>
                                      <td><input name="out_of_stock[]" type="checkbox" value="1" class="checkbox"/></td>
                                      <td><select name="menu_size_map_id[]" class="custombox" style="width:300px">
											<?php $itemmenulist = $menu->getToppingMenuItem(); ?>
                                            <option value="">please select</option>
                                            <?php foreach ($itemmenulist as $irow):?>
                                            <option value="<?php echo $irow['id'];?>"><?php echo $irow['price'];?></option>
                                            <?php endforeach;?>
                                        </select>
                                      </td>
                                      <td>                                     
...
$(document).ready(function(){
  ...
  $("#addToppings").click(function(){
	  ...
	  if(incrementtopping > 10)
	  {
		...
		var toppingmaincontent='<td><input name=\"topping_name[]"+increment+"\" type=\"text\" class=\"inputbox\"  size=\"55\"></td><td><input name=\"out_of_stock[]\" type=\"checkbox"\ value="\1\" class=\"checkbox\"></td><td><select name=\"menu_size_map_id[]\" class=\"custombox\" style=\"width:300px\"></select></td><td></td>';	
