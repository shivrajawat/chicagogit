...
<div class="block-top-header">
  <h1><img src="images/posts-sml.png" alt="" /><?php echo _ATTR_TITLE1;?></h1>
  <div class="divider"><span></span></div>
</div>
<p class="info"><span><?php echo $core->langIcon();?></span><?php echo _ATTR_INFO1 . _REQ1 . required() . _REQ2;?></p>
<div class="block-border">
  <div class="block-header">
    <h2><?php echo _ATTR_SUBTITLE1 . $row['attribute'];?></h2>
  </div>
